...
DATA_PATH = {
    "psychiatry": "psychiatryLLM/papers_psychiatry_",
}

PROMPT_DICT = {
    "paper": (
        "Below is an paper abstract that describes a psychiatry science, please learn knowledge from the paper. "
        "### Title:\n{Title}\n\n### Abstract:\n{Abstract}"
    ),
}
